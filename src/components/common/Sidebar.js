        ...
        <>
            <nav className={clsx('sidebar sidebar-offcanvas', {"active": active})} id="sidebar">
                <div
                    ...
                    <Link to={"/"} className="sidebar-brand brand-logo"><img src={aurora_logo}
                                                                             alt="logo"/></Link>
                ...
                <ul className="nav">
                    ...
                    <li className="nav-item menu-items">
                        <a className="nav-link" data-bs-toggle="collapse" href="#ui-basic-2"
                           aria-expanded="false" // xem lại phần này
                           aria-controls="ui-basic">
                            <span className="menu-icon">
                        ...
                        <div className="collapse" id="ui-basic-2">
                            <ul className="nav flex-column sub-menu">
                                <li className={clsx("nav-item"
                                    , {"section-active": param.section === undefined && window.location.pathname === "/blogs"})}>
                                    <Link to="/blogs" className="nav-link">Blog management</Link>
                                </li>
                                <li className={clsx("nav-item", {"section-active": param.section === "new"})}>
                                    <Link to="/blogs/new" className="nav-link">New Blog</Link>
                                </li>
                                <li className={clsx("nav-item", {"section-active": param.section === "category"})}>
                                    <Link to="/blogs/category" className="nav-link">Blog Category</Link>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li className="nav-item menu-items">
                        <a className="nav-link" data-bs-toggle="collapse" href="#ui-basic-3"
                           aria-expanded="false" // xem lại phần này
                           aria-controls="ui-basic">
                            <span className="menu-icon">
